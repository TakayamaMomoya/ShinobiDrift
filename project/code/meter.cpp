...
const D3DXVECTOR2 SIZE_METER = { 0.13f, 0.22f };	// メーター背景のサイズ
const D3DXVECTOR3 POS_METER = { 1.0f - SIZE_METER.x - 0.001f, 1.0f - SIZE_METER.y - 0.0005f, 0.0f };	// メーターの位置
const D3DXVECTOR2 SIZE_NUMBER = { 0.015f, 0.04f };	// メーターの数字のサイズ
...
HRESULT CMeter::Init()
{
	...
	{// メーター値の生成
		...
		// トランスフォーム設定
		m_pNumber->SetPosition(D3DXVECTOR3(POS_METER.x - SIZE_NUMBER.x * 2, POS_METER.y - SIZE_NUMBER.y * 2.0f, 0.0f));
