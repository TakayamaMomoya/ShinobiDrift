...
const float DEFAULT_LENGTH_TEX = 2000.0f;	// テクスチャを貼る際の基準の長さ
const float DEFAULT_CORDINATE_TEX = 1.0f;	// テクスチャを貼る際のデフォルト座標
const int ACCURACY_LENGTH = 30;	// 長さの精度
}
