...
const D3DXVECTOR3 POS_MENU_DEFAULT = { 0.6f,0.5f,0.0f };	// メニューのデフォルト位置
const D3DXVECTOR2 SIZE_MENU_DEFAULT = { 0.3f,0.2f };	// メニューのデフォルトサイズ
const D3DXVECTOR3 POS_MENU_INITIAL = { 1.0f + SIZE_MENU_DEFAULT.x,0.5f,0.0f };	// メニューの初期位置
}
